...
PanelWindow {
    ...
    readonly property var actions: [
        ...
        { icon: "󰒲", label: "Sleep", shortcut: "S", command: ["doas", "openrc-shutdown", "-s", "0"], confirm: false },
        { icon: "󰜉", label: "Restart", shortcut: "R", command: ["doas", "openrc-shutdown", "-r", "0"], confirm: true },
        { icon: "󰐥", label: "Shutdown", shortcut: "P", command: ["doas", "openrc-shutdown", "-p", "0"], confirm: true },
        { icon: "󰤄", label: "Hibernate", shortcut: "H", command: ["doas", "openrc-shutdown", "-h", "0"], confirm: true }
    ]
